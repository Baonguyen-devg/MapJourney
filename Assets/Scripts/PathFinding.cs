...
{
    public static List<Vector3> FindPathDijkstra(Point startPoint, Point endPoint)
    {
    ...
    private static Point GetPointWithSmallestDistance(List<Point> openList, Dictionary<Point, float> distances)
    {
    ...
    public static List<Vector3> GetBezierPathFromRetrace(List<Vector3> retracePath)
    {
    ...
    private static List<Vector3> RetracePath(Dictionary<Point, Point> cameFrom, Point startPoint, Point endPoint)
    {
